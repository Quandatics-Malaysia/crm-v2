/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: b9cd18f4067bf1b93c7fbcb7125d546e)
// Runtime types generated with workerd@1.20260810.1 2026-08-10 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	BACKUP_VAULT: R2Bucket;
	CONTROL_DB: D1Database;
	ENVIRONMENT: "staging" | "production" | "development";
	ACCESS_TEAM_DOMAIN: "example.cloudflareaccess.com";
	ACCESS_AUD: "replace-with-staging-access-application-audience" | "replace-with-production-access-application-audience" | "replace-with-access-application-audience";
	BOOTSTRAP_OWNER_EMAIL: "owner@example.com";
	OPERATOR_ORIGIN: "https://control-staging.example.com" | "https://control.example.com";
	ENTITLEMENT_SIGNING_KEY_ID: "vendor-staging-1" | "vendor-production-1" | "vendor-development-1";
	ENTITLEMENT_SIGNING_PRIVATE_JWK: string;
	INSTALL_TOKEN_PEPPER: string;
	ASSETS: Fetcher /* crm-control-plane-assets-staging */ | Fetcher /* crm-control-plane-assets-production */ | Fetcher /* crm-control-plane-assets */;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ENTITLEMENT_SIGNING_PRIVATE_JWK: string;
		INSTALL_TOKEN_PEPPER: string;
		ASSETS: Fetcher /* crm-control-plane-assets-staging */;
	}
	interface ProductionEnv {
		...
		ENTITLEMENT_SIGNING_PRIVATE_JWK: string;
		INSTALL_TOKEN_PEPPER: string;
		ASSETS: Fetcher /* crm-control-plane-assets-production */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "BOOTSTRAP_OWNER_EMAIL" | "OPERATOR_ORIGIN" | "ENTITLEMENT_SIGNING_KEY_ID" | "ENTITLEMENT_SIGNING_PRIVATE_JWK" | "INSTALL_TOKEN_PEPPER">> {}
}
